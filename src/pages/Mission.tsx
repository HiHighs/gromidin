            ...
            <ol className={styles.parts}>
              ...
              <li className={styles.part}>
                ...
                <ul>
                  ...
                  <li>
                    Based on <strong>drone technology</strong> (collaboration
                    with drone experts) with help of{' '}
                    <strong>satellite-information</strong>
                    <ul>
                      <li>
                        Together with partners, we are convinced that{' '}
                        <strong>monitoring by drones</strong> will become a
                        basis for decision taking by contractor companies in
                        spraying applications and by farmers.
                      </li>
                      <li>
                        Focus is on <strong>immediate advising</strong>{' '}
                        contractor companies and distributors how to set up a
                        business model.
                      </li>
                      <li>
                      ...
                      <li>
                        ...
                        different crops, as well as diseases and insects like
                        the Colorado Beetle.
                      </li>
                      <li>
              ...
              <li className={styles.part}>
                ...
                <p>
                  ...
                  various possibilities for digital farming in Flanders in a
                  calm and constructive way. At the end of the day, every arable
                  farmer or adviser in crop protection wants to be proud of
                  their work, to have fun We are convinced that precision
                  agriculture will give young, dynamic farmers and advisors
                  extra pleasure in their work.
                </p>
                <p>
